      ...
      <div className="mb-[100px]">
        <div className="carousel w-full h-[90vh]">
          <div id="slide1" className="carousel-item relative w-full">
            ...
            <div className="absolute lg:left-[190px] left-[70px]   top-[30%]">
              ...
              <Link to="/search_donor">
                <button className="btn bg-[#ea062b] text-white border-none hover:bg-black hover:text-white">
                  Search Donor
                </button>
              </Link>
            </div>
          ...
          <div id="slide3" className="carousel-item relative w-full">
            <img
              src="https://images.unsplash.com/photo-1615461065624-21b562ee5566?q=80&w=1640&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              className="w-full"
            />
            <div className="absolute lg:left-[190px] left-[70px]    top-[30%]">
              <h3 className="text-white lg:text-5xl text-2xl mb-3  font-semibold">
