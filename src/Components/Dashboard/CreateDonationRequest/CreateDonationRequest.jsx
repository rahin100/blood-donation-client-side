...
const CreateDonationRequest = () => {
  ...
  useEffect(() => {
    fetch("https://blood-donation-server-side-three.vercel.app/all_districts", { withCredentials: true })
      .then((res) => res.json())
  ...
  const [allUsers] = useCollectUsers()
  ...
  const handleRequestSubmit = (e) => {
    ...
    axiosSecure
      .post("/dashboard/donation-request", donationRequestData)
      .then((res) => {
